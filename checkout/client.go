...
func (c *Client) GenerateCheckoutLink(
	ctx context.Context,
	request *sdk.GenerateCheckoutLinkRequest,
	opts ...option.RequestOption,
) (*sdk.GenerateCheckoutLinkResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/api/checkout/v1/orders"
	...
	var response *sdk.GenerateCheckoutLinkResponse
