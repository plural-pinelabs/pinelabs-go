...
func (c *Client) AuthorizeApplePayPayment(
	ctx context.Context,
	...
	paymentsID string,
	request *sdk.AuthorizePaymentRequest,
	opts ...option.RequestOption,
) (*sdk.AuthorizePaymentResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(
		baseURL+"/api/pay/v1/orders/%v/payments/%v/authorize",
		orderID,
		paymentsID,
	)
	...
	var response *sdk.AuthorizePaymentResponse
