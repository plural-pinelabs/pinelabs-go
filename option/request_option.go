...
// WithRequestTimestamp sets the requestTimestamp request header.
//
// ISO 8601 UTC timestamp of the request. Used for idempotency and audit.
func WithRequestTimestamp(requestTimestamp *time.Time) *core.RequestTimestampOption {
	return &core.RequestTimestampOption{
		RequestTimestamp: requestTimestamp,
	}
}

// WithRequestID sets the requestID request header.
//
// Use a global unique identifier [GUID] for the request.
func WithRequestID(requestID *string) *core.RequestIDOption {
	return &core.RequestIDOption{
		RequestID: requestID,
	}
}
